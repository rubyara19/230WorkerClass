namespace _230_6_1
{
    ...
    internal class Program
    {
        ...
        public class SalaryWorker : Employee
        {
            ...
            public new string earnings()
            {
                Console.WriteLine("Salary Worker   (S)\nID   Last        First       Weekly Pay");
                return String.Format("{0,-5}{1,-12}{2,-12}{3,-10}", this.id_num.ToString(), this.first_name, this.last_name, (Math.Round((this.salary / 52), 2)).ToString());
        ...
        public class HourlyWorker : Employee
        {
                ...
                public string earnings()
                {
                    ...
                    return String.Format("{0,-5}{1,-12}{2,-12}{3,-10}", this.id_num.ToString(), this.first_name, this.last_name, Math.Round(weeklypay, 2).ToString());
                }
        }
        ...
        {
            SalaryWorker Perez = new SalaryWorker(123, "Martha", "Perez", (float)(56785.59));
            HourlyWorker Smith = new HourlyWorker(435, "Joe", "Smith", (float)(18.67), (float)(42.5));
            CommissionWorker Mendez = new CommissionWorker(356, "Anthony", "Mendez", (float)(30563.56), (float)(.003),(float)(57864.53));
            PieceWorker James = new PieceWorker(452, "Jimmy", "James", (float)(0.50), (float)(1201));

            Console.WriteLine(Perez.earnings());
            Console.WriteLine(Smith.earnings());
            Console.WriteLine(Mendez.earnings());
            Console.WriteLine(James.earnings());
